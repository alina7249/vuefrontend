          ...
          <div class="bg-[#2D3748] p-6 rounded-xl shadow-sm border border-[#4A5F8B]">
            <div class="flex justify-between mb-6">
              ...
              <button class="flex flex-col items-center justify-center text-[#4A5F8B]">
                <div
                  class="w-12 h-12 rounded-full bg-[#4A5F8B]/20 flex items-center justify-center text-[#4A5F8B] mb-2"
                >
            ...
            <div class="space-y-4">
              <button
                class="w-full py-2 bg-[#4A5F8B] text-[#F5F7FA] rounded-lg font-medium hover:bg-[#6B7C93] transition-colors flex items-center justify-center"
              >
                <i class="fa-solid fa-download mr-2"></i>
                下载原图
              </button>
              <button
                class="w-full py-2 bg-[#2D3748] text-[#B8C6D8] border border-[#4A5F8B] rounded-lg font-medium hover:bg-[#4A5F8B] hover:text-[#F5F7FA] transition-colors flex items-center justify-center"
              >
            ...
            <div class="space-y-4">
              <template v-for="option in mockPhotoPost.licensingOptions" :key="option.id">
                <div class="p-4 bg-[#1E2532] rounded-lg border border-[#4A5F8B]">
                  ...
                  <button
                    class="w-full py-2 bg-gradient-to-r from-[#4A5F8B] to-[#2D3748] text-[#F5F7FA] rounded-lg font-medium hover:from-[#6B7C93] hover:to-[#4A5F8B] transition-colors text-sm border border-[#4A5F8B]"
                  >
                    购买授权
                  </button>
                </div>
    ...
    comments: [
      {
        ...
        author: '摄影爱好者小王',
        avatar:
          'https://space.coze.cn/api/coze_space/gen_image?image_size=square&prompt=photography%20enthusiast%20young%20male&sign=a1aab7d30fd53bf1223d770fddcbda60',
        content: '构图非常出色，极简主义的典范之作！',
        date: '2023-10-26',
      },
      {
        id: 2,
        author: '艺术评论家小李',
        avatar:
          'https://space.coze.cn/api/coze_space/gen_image?image_size=square&prompt=art%20critic%20male%20glasses&sign=9e911992d017c39984632bede247fe6f',
        content: '光影的运用极具艺术性，黑白对比强化了视觉冲击力。',
        date: '2023-10-25',
      },
      {
        id: 3,
        author: '建筑摄影师老张',
        avatar:
          'https://space.coze.cn/api/coze_space/gen_image?image_size=square&prompt=architectural%20photographer%20middle%20aged&sign=c5f7e7acba71e7ff8e22dfcc42f1c95b',
        content: '作为同行，非常欣赏这种对线条和几何感的捕捉！',
        date: '2023-10-25',
      },
    ],
    isLiked: false,
