<template>
  <div>
    ...
    <div v-else class="mb-8 p-4 bg-[#E6EBF2] rounded-lg border border-[#B8C6D8] text-center">
      <p class="text-[#4A5059]/70 mb-3">登录后可以参与艺术摄影交流</p>
    ...
    <div class="space-y-6">
          ...
          <div class="flex-1">
            ...
            <div class="flex items-center space-x-4">
              <button
                ...
                :class="{
                  'text-[#4A5F8B]': comment.isLiked,
                  'text-[#4A5059]/50 hover:text-[#4A5059]': !comment.isLiked
                }"
              >
                <motion.i
              ...
              <button
                @click="setReplyingTo(replyingTo === comment.id ? null : comment.id)"
              ...
              >
                ...
                <div class="flex-1">
                  ...
                  <button
                    ...
                    :class="{
                      'text-[#4A5F8B]': reply.isLiked,
                      'text-[#4A5059]/50 hover:text-[#4A5059]': !reply.isLiked
                    }"
                  >
      ...
      <button
        ...
        @click="setShowFullComments(!showFullComments)"
...
const setShowFullComments = (value: boolean) => {
  showFullComments.value = value;
};

const displayComments = computed(() =>
  showFullComments.value ? comments : comments.slice(0, 2)
);
</script>
