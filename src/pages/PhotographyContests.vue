      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 space-y-6">
          ...
          <div class="space-y-6">
              ...
              <div class="md:flex">
                ...
                <div class="p-5 md:w-2/3">
                  ...
                  <template v-if="contest.organizer">
                    <p class="text-xs text-[#F5F7FA]/80 mb-4">
                  ...
                  <div class="mb-4">
                    ...
                    <div class="flex flex-wrap gap-2">
                      <span
                        v-for="(prize, index) in contest.prizes.slice(0, 3)"
                        :key="index"
                  ...
                  <div class="flex flex-wrap gap-2 mb-4">
                    <button
                      v-for="(tag, index) in contest.tags.slice(0, 5)"
                      :key="index"
                      @click="toggleTag(tag)"
            ...
            <div
              v-if="filteredContests.length === 0"
              class="p-8 bg-[#2D3748] rounded-xl border border-[#4A5F8B] text-center"
            >
          ...
          <!-- 分页 -->
          <div v-if="filteredContests.length > 0" class="flex justify-center">
        ...
        <div class="lg:col-span-1 space-y-6">
          ...
          <div class="bg-gradient-to-r from-[#4A5F8B] to-[#6B7C93] rounded-xl p-6 shadow-sm border border-[#4A5F8B] text-[#F5F7FA]">
            ...
            <div class="space-y-4">
              ...
              >
                <div class="w-16 h-16 flex-shrink-0 flex flex-col items-center justify-center bg-[#2D3748]/30 rounded-lg text-[#F5F7FA]">
                  <span class="text-lg font-bold">{{ getDaysUntilDeadline(contest.deadline) }}</span>
            ...
            <RouterLink
              to="#"
              class="mt-4 text-sm text-[#F5F7FA] hover:text-[#FFFFFF] transition-colors flex items-center justify-center w-full"
            >
            ...
            <div class="space-y-3">
              <div class="flex items-start">
                ...
                <div class="flex-1 space-y-2">
                  <div class="flex items-center">
                    <span class="w-6 h-6 rounded-full bg-[#4A5F8B] text-[#F5F7FA] text-xs flex items-center justify-center flex-shrink-0">15</span>
              ...
              <div class="flex items-start">
                ...
                <div class="flex-1 space-y-2">
                  ...
                  <div class="flex items-center">
                    <span class="w-6 h-6 rounded-full bg-[#4A5F8B] text-[#F5F7FA] text-xs flex items-center justify-center flex-shrink-0">30</span>
              ...
              <div class="flex items-start">
                ...
                <div class="flex-1 space-y-2">
                  <div class="flex items-center">
                    <span class="w-6 h-6 rounded-full bg-[#4A5F8B] text-[#F5F7FA] text-xs flex items-center justify-center flex-shrink-0">31</span>
          ...
          <div class="bg-gradient-to-r from-[#4A5F8B] to-[#6B7C93] rounded-xl p-6 shadow-sm text-white">
            ...
            <button class="w-full py-2 bg-[#F5F7FA] text-[#4A5F8B] font-medium rounded-lg hover:bg-[#FFFFFF] transition-colors">
              立即创建
            </button>
          </div>
        </div>
...
const sortBy = ref('deadline') // deadline, popular, newest
...
const filteredContests = computed(() => {
  ...
  if (selectedType.value !== '全部') {
    contests = contests.filter(contest => contest.type === selectedType.value)
  }
  
  // 按状态过滤
  if (selectedStatus.value !== '全部') {
    contests = contests.filter(contest => contest.status === selectedStatus.value)
  }
  ...
  if (selectedTags.value.length > 0) {
    contests = contests.filter(contest => 
      selectedTags.value.some(tag => contest.tags.includes(tag))
    )
  }
